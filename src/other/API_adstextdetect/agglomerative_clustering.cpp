...
HierarchicalClustering::HierarchicalClustering(vector<Region> &_regions, string keyfile ): regions(_regions)
{	
    //boost.load("/home/chigo/working/caffe_img_classification/test/src/API_adstextdetect/trained_boost_groups.xml", "boost");
    boost.load(keyfile.c_str(), "boost");
}
