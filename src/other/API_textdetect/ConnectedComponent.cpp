...
static bool Sort_ComponentProperty(const ComponentProperty& elem1, const ComponentProperty& elem2)
{
...
//    });
	...
	//add by chigo
	sort( properties.begin(), properties.end(), Sort_ComponentProperty );
