...
static bool SortComp(const ComponentProperty elem1, const ComponentProperty elem2)
{
...
//    });
	sort( properties.begin(), properties.end(), SortComp );
