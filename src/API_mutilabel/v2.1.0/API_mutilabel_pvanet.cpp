...
#include "plog/Log.h"
#include "API_mutilabel/v2.1.0/API_mutilabel_pvanet.h"
...
{	
	...
	float w_ratio = 1.0;
	float h_ratio = 1.0;
	IplImage* imgResize = api_commen.ResizeImg( image, w_ratio, h_ratio, IMAGE_SIZE );	//320:30ms,512:50ms,720:80ms
