...
path='/home/chigo/image/mainboby/testing/JPEGImages/'
path_xml='/home/chigo/image/mainboby/testing/Annotations/'

find $path/ -name "*.jpg" >list_jpg.txt

################################DL_ImgLabel################################
#Demo_mainboby -get_xml_bing_roi_for_1_0_0 queryList.txt loadXmlPath
../Demo_mainboby -get_xml_roi list_jpg.txt $path_xml $savepath
