...
#new add label
in_Annotations='/home/chigo/image/mutilabel/mix/Annotations/'
in_Images='/home/chigo/image/mutilabel/mix/JPEGImages/'
################################Path################################
savepath='res/'
rm -r $savepath
mkdir $savepath
...
################################DL_ImgLabel################################
#Demo_mutilabel -count_data loadXMLPath loadImagePath svPath
../../Demo_mutilabel -count_data $savepath$loadXMLList $in_Images $savepath
